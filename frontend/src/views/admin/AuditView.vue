  ...
  <div class="admin-view">
    <div class="view-header">
      ...
      <div class="audit-filters">
        <el-input v-model="action" :placeholder="t('auditAction', ui.lang)" clearable style="width: 200px" @keyup.enter="load" />
    ...
    <el-table :data="entries" v-loading="loading" class="audit-table">
      ...
      <el-table-column prop="username" :label="t('auditUser', ui.lang)" width="130" />
      <el-table-column prop="action" :label="t('auditAction', ui.lang)" min-width="160" />
      <el-table-column prop="method" label="method" width="80" />
      <el-table-column prop="path" :label="t('auditPath', ui.lang)" min-width="200" />
      <el-table-column prop="status" :label="t('auditStatus', ui.lang)" width="80" />
    </el-table>
  </div>
</template>
